...
namespace Lab_8
{
    class Table
    {
        public void GetTable (double[] velumesOfX, double[] velumesOfY)
        {
        ...
        private string HeadPrint(int longestNumLenght, string LineStart, string LineEnd)
        {
        ...
        private string FillTableEmptyness(int emptynessLenght)
        {
            string result = string.Empty;
            for (int i = 0; i < emptynessLenght; i++) result += '.';
            return result;
        }
        private string StringWithNum(int longestNumLenght, string num)
        {
            string result = string.Empty;
            result += "│";
        ...
        private int GetLongestNum(double[] input)
        {
            int result = 0;
